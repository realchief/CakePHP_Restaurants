            ...
            <div class="row">
                <div class="box my-box">
                    <div class="box-header with-border">
                        ...
                        <?php
                            echo $this->Form->create('paymentAdd', [
                                    'id' => 'paymentAddForm',
                                    'type'  =>'file'
                            ]);
                        ?>                    
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label for="paymentMethodImage" class="col-sm-3 control-label">Payment Method Image<span class="star">*</span></label>
                                <div class="col-sm-4">
                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                        <div class="form-control" data-trigger="fileinput"><i class="glyphicon glyphicon-file fileinput-exists"></i>
                                            <span class="fileinput-filename paymentMethodImage"></span>
                                        </div>
                                        <span class="input-group-addon btn btn-default btn-file">
                                            <span class="fileinput-new">Select file</span>
                                            <span class="fileinput-exists">Change</span>
                                            <input type="file" id="paymentMethodImage" name="paymentMethodImage">
                                        </span>
...
<script type="text/javascript">
    function paymentAddEdit(){
        ...
        var paymentMethodImage = $('input[type=file]').val();        
        $('.error').html('');
