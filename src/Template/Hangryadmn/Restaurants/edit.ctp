                            ...
                            <div class="tab-pane" id="tab_2">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <img src="<?php echo BASE_URL.'webroot/uploads/storeLogos/'.$restDetails['logo_name'] ?>" width="80" height="80" onerror="this.src='<?php echo BASE_URL;?>webroot/images/no_store.jpg'">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2 margin-l-15 checkbox checkbox-inline">
                                            <?php  echo $this->Form->input('Close',[
                                                'class'=>'',
                                                'hiddenField'=>false,
                                                'div' => false,
                                                'type' => 'checkbox',
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <label class="radio-inline">
                                                <input type="radio" name="restaurant_pickup" class="minimal" value="No" <?= ($restDetails['restaurant_pickup'] == 'No') ? 'checked' : '' ?>>
                                                No
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <label class="radio-inline no-padding-left">
                                                <input type="radio" name="restaurant_delivery" class="minimal" <?= ($restDetails['restaurant_delivery'] == 'Yes') ? 'checked' : '' ?> value="Yes">
                                                Yes
                                            </label>
                                            <label class="radio-inline">
   ...
   <!--Delivery Info-->
                        ...
                        <div class="tab-pane" id="tab_4">
                                <div class="box-body">
                                    ...
                                    <div class="form-group" id="orderEmail" style="<?= ($restDetails['email_order'] == 'No') ? 'display:none' : '' ?>">
                                    ...
                                    <div class="form-group" id="smsOrder" style="<?= ($restDetails['sms_option'] == 'No') ? 'display:none' : '' ?>">
                                                ...
                                                <div class="col-sm-4">
                                                    <label class="radio-inline no-padding-left">
                                                        <input type="radio"
                                                            ...
                                                            <?= (in_array($vPay['id'],$editPayMethod)) ? 'checked' : '' ?>
                                                               class="minimal"
                                                               value="Y" >
                                                        Yes
                                                    </label>
                                                        ...
                                                        if(!empty($value)) { ?>
                                                            <div class="col-xs-3">
                                                                <div class="promoimagewrap" id="imagelist_<?php echo $value['id'];?>">
                                                                    <img src="<?php echo BASE_URL.'webroot/uploads/storeBanners/'.$value['promo_image']; ?>" alt="" width="100" height="150" onerror="this.src='<?php echo BASE_URL;?>webroot/images/no_store.jpg'">
...
<script>
    ...
    function addRestaurant() {
        ...
        var img             = $.trim($("#restaurant_logo").val().split('.').pop().toLowerCase());
