            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                       <a class="btn btn-primary pull-right" href="<?php echo ADMIN_BASE_URL;?>coupons/add"><i class="fa fa-plus"></i> Add New</a>
                    </div>
                                ...
                                <?php if(!empty($couponsList)) {
                                    foreach($couponsList as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $value['restaurant']['restaurant_name'];?></td><td><?php echo $value['coupon_code'];?></td>
...
<script type="text/javascript">
    ...
    function changeStatus(id, changestaus, field, urlval, action)
    {
       $.ajax({
            type   : 'POST',
            url    : jssitebaseurl+'coupons/ajaxaction',
    ...
    function deleteRecord(id, urlval, action, page, loadDiv)
    {
        ...
        if(confirm(str))
        {
            $.ajax({
                type   : 'POST',
                url    : jssitebaseurl+'coupons/deleteCoupon',
