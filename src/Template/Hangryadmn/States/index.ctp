            ...
            <div class="col-xs-12">
                <div class="box my-box">
                    <div class="box-header">
                       <a class="btn btn-primary pull-right" href="<?php echo ADMIN_BASE_URL;?>states/add"><i class="fa fa-plus"></i> Add New</a>
                    </div>
...
<script type="text/javascript">
    ...
    function changeStatus(id, changestaus, field, urlval, action)
    {
       $.ajax({
            type   : 'POST',
            url    : jssitebaseurl+'states/ajaxaction',
    ...
    function deleteRecord(id, urlval, action, page, loadDiv)
    {
        ...
        if(confirm(str))
        {
            $.ajax({
                type   : 'POST',
                url    : jssitebaseurl+'states/deleteState',
