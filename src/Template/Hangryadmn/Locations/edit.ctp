                    ...
                    <div class="box-header with-border">
                       ...
                       <?php
                            if(!empty($locationList)) {
                                echo $this->Form->create($locationList, [
                                    'id' => 'areaEditForm'                                
                                ]);                                                          
                             } 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">                                    
                                    <?= $this->Form->input('state_id',[
                                        ...
                                        'class' => 'form-control',
                                        'options'=> $statelist,
                                        'value' => isset($locationList['state_id']) ? $locationList['state_id'] :  '',
                                ...
                                <div class="col-sm-4">
                                   <div id="cityList">
                                      <?= $this->Form->input('city_id',[
                                            ...
                                            'options' => $citylist,
                                            'value' => isset($locationList['city_id']) ? $locationList['city_id'] :  '',
                                            'label' => false
                                        ]); ?>
                                    </div>    
   ...
   function locationAddEdit(){
        ...
        if(state_id == '') {
            ...
            $.ajax({
                ...
                data   : {id:editid, city_id:city_id, area_name:area_name},
                success: function(data){
                    if($.trim(data) == 0) {
                        $("#areaEditForm").submit();
                    }else {
