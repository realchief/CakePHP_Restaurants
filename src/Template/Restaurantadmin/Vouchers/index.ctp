            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                       <a class="btn btn-primary pull-right" href="<?php echo REST_BASE_URL;?>vouchers/add"><i class="fa fa-plus"></i> Add New</a>
                    </div>
                                ...
                                <?php if(!empty($vouchersList)) {
                                    foreach($vouchersList as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo REST_BASE_URL;?>vouchers/edit/<?php echo $value['id']; ?>"><i class="fa fa-pencil"></i></a>
