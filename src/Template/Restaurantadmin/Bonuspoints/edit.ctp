                ...
                <div class="box box-info">
                    ...
                    <?php
                        ...
                        echo $this->Form->input('restaurant_id',[
                            ...
                            'id'   => 'restaurant_id',
                            'class' => 'form-control',
                            'value' => $bonusList[0]['restaurant_id'],
                            'readolny' => 'readolny',
                            'label' => false
                        ]);
                    ?>
                    ...
                    <div class="box-body">
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-4">
                                <?= $this->Form->input('rest_id',[
                                    'type' => 'text',
                                    'id'   => 'rest_id',
                                    'class' => 'form-control',
                                    'value' => $bonusList[0]['restaurant']['restaurant_name'],
                                    'readonly' => 'readonly',
                                    'label' => false
                                ]) ?>
...
<script type="text/javascript">
    ...
    function bonusAddEdit(){
        var restaurant_id = $.trim($("#rest_id").val());
