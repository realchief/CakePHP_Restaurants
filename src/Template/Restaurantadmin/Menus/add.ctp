<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li> <a href="<?php echo REST_BASE_URL;?>menu">Manage Menu</a></li>
...
<script>
    function addMenu() {
        ...
        if(menu_name == '') {
            ...
            $(".priceErr").addClass('error').html('Please enter menu price');
            $("#menu_price").focus();
            return false;
        }*/

        if(price_option != '' && price_option == 'single' && menu_price == '' ) {
        ...
        if(category_id == ''){
            ...
            if (option == 'Yes') {
                ...
                $.ajax({
                    ...
                    data   : {'productId' : '','category_id' : category_id,'price_option' : price_option,'menuLength' : menuLength,'action' : 'getAddons'},
