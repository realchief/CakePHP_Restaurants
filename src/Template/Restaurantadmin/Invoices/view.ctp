<div class="content-wrapper">
    <section class="content-header">
      ...
      <a href="<?= REST_BASE_URL ?>invoices" class="order-back">Back</a>
      </span>
    </section>
        ...
        <div class="order_view_page">
            ...
            <div class="col-xs-12">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <td style="font-size:16px;font-weight:normal" align="right" colspan="2">Paid Gross Sale (Including Tax, Delivery charge, Tips) :</td>
