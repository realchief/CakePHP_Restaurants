            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <!--<a class="btn btn-primary pull-right" href="<?php /*echo REST_BASE_URL;*/?>drivers/add"><i class="fa fa-plus"></i> Add New</a>-->
                    </div>
                            ...
                            <?php if(!empty($invoiceDetails)) {
                                foreach($invoiceDetails as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo REST_BASE_URL ?>invoices/view/<?php echo $value['id'] ?>">View</a>
                                        </td>
                                    </tr>
                                <?php }
                            } ?>
